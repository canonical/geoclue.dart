...
// in geoclue/test/manager_test.dart.
...
class _FakeDBusObjectPath_2 extends _i1.SmartFake
    implements _i4.DBusObjectPath {
  _FakeDBusObjectPath_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeDBusSignature_3 extends _i1.SmartFake implements _i4.DBusSignature {
  _FakeDBusSignature_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeDBusClient_4 extends _i1.SmartFake implements _i2.DBusClient {
  _FakeDBusClient_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeDBusValue_6 extends _i1.SmartFake implements _i4.DBusValue {
  _FakeDBusValue_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockDBusPropertiesChangedSignal extends _i1.Mock
  ...
  @override
  String get propertiesInterface => (super.noSuchMethod(
        Invocation.getter(#propertiesInterface),
        returnValue: '',
      ) as String);
  @override
  Map<String, _i4.DBusValue> get changedProperties => (super.noSuchMethod(
        Invocation.getter(#changedProperties),
        returnValue: <String, _i4.DBusValue>{},
      ) as Map<String, _i4.DBusValue>);
  @override
  List<String> get invalidatedProperties => (super.noSuchMethod(
        Invocation.getter(#invalidatedProperties),
        returnValue: <String>[],
      ) as List<String>);
  @override
  ...
  _i4.DBusObjectPath get path => (super.noSuchMethod(
        ...
        returnValue: _FakeDBusObjectPath_2(
          this,
          Invocation.getter(#path),
        ),
  ...
  @override
  List<_i4.DBusValue> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i4.DBusValue>[],
      ) as List<_i4.DBusValue>);
  @override
  _i4.DBusSignature get signature => (super.noSuchMethod(
        Invocation.getter(#signature),
        returnValue: _FakeDBusSignature_3(
          this,
          Invocation.getter(#signature),
        ),
      ) as _i4.DBusSignature);
}
...
class MockDBusRemoteObject extends _i1.Mock implements _i8.DBusRemoteObject {
  ...
  _i6.Future<_i5.DBusIntrospectNode> introspect() => (super.noSuchMethod(
        ...
        returnValue:
            _i6.Future<_i5.DBusIntrospectNode>.value(_FakeDBusIntrospectNode_5(
          this,
          Invocation.method(
            #introspect,
            [],
  ...
  _i6.Future<_i4.DBusValue> getProperty(
    ...
    _i4.DBusSignature? signature,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i4.DBusValue>.value(_FakeDBusValue_6(
          this,
          Invocation.method(
            #getProperty,
            [
